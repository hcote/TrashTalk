...
logger = logging.getLogger('cleanups.google_sheets')

# TODO: Remove variables and use settings directly.
GOOGLE_SHEETS_VALIDATION = settings.GOOGLE_SHEETS_VALIDATION
