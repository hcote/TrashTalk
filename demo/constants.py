...
DEFAULT_GEOLOC = "{0}, {1}".format(DEFAULT_CITY, DEFAULT_STATE)

# State codes mapped to state names
STATE_NAME_MAP = {
        'AK': 'Alaska',
        'AL': 'Alabama',
        'AR': 'Arkansas',
...
COUNTRY_CODE_MAP = {country['name']: country['code'] for country in COUNTRIES}
# Very rough timezone estimate..
COUNTRY_TIMEZONES_MAP = {country['name']: country['timezones'][0] for country in COUNTRIES}
